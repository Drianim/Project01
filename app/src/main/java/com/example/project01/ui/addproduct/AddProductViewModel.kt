package com.example.project01.ui.addproduct
...
import com.example.project01.domain.usecase.CreateProductUseCase
import com.example.project01.util.fromCurrency
...
class AddProductViewModel @Inject constructor(
    ...
    fun createProduct(description: String, price: String, imageUri: Uri?) = viewModelScope.launch {
        ...
        _imageUriErrorResId.value = getDrawabledResIdIfNull(imageUri)
    ...
    private fun getDrawabledResIdIfNull(value: Uri?): Int {
